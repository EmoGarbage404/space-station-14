...
public sealed class MechGrabberSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MechGrabberComponent, AfterInteractEvent>(OnInteract);
    ...
    private void OnInteract(EntityUid uid, MechGrabberComponent component, AfterInteractEvent args)
    {
